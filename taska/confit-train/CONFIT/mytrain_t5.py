...
# model_name = 'henryu-lin/t5-large-samsum-deepspeed'
# model_name = 'google/t5-v1_1-base'
model_name = 'google/t5-v1_1-large'


output_dir='output-' + model_name.split('/')[1] + '-finetune-3'
...
# model=T5ForConditionalGeneration.from_pretrained(model_args.model_name_or_path,max_position_embeddings=data_args.max_source_length)
