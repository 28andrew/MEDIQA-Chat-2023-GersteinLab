...
import wandb
os.environ['WANDB_API_KEY'] = 'e6ad08a8e80e50e3195d3e1d27ce9ebfd8ef0997'
...
args = [
    ...
    '--train_file', 'New-TaskA-TrainingData.json',
    '--validation_file', 'New-TaskA-ValidationData.json',
    '--test_file', 'New-TaskA-ValidationData.json',
    ...
    with jsonlines.open(file_path, "r") as rfd:
        ...
        for data in rfd:
            try:
                ...
                skipped += 1
                print(f'Skipped {skipped} row due to bad processing')
    return result
