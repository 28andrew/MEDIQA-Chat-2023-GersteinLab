# modify the compute loss so that label smoothing loss and out pmi loss can be compatible.
...
class Seq2SeqTrainer(Trainer):
    ...
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        if labels is not None:
            ...
            loss_ls = self.label_smoother(outputs, labels)
            loss_pmi = outputs['loss']
            loss = loss_ls + loss_pmi
