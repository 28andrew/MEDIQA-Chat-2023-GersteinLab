...
from model.local_t5_ls import T5ForConditionalGeneration
...
# model_name = 'henryu-lin/t5-3b-samsum-deepspeed'
# model_name = 'pere/t5-base-xsum'
# model_name = 'ffrmns/t5-small_XSum-finetuned'
...
alpha=0.01
# outdir='output-' + model_name.split('/')[1] + '-'
# outdir='output-' + model_name.split('/')[1] + '-baseline-epoch-20-new'
outdir = '677-samsum-t5'
...
args=[
    ...
    # '--model_name_or_path','aristotletan/t5-small-finetuned-xsum',
...
# config=ProphetNetConfig.from_pretrained(model_args.model_name_or_path)
